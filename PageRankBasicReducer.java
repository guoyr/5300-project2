...
public class PageRankBasicReducer extends Reducer<Text, Text, Text, Text> {
	...
	protected void reduce(Text key, Iterable<Text> values, Context context)
		...
		Float randomJumpFactor = (1 - dampingFactor) / PageRankBasic.totalNodes;
		...
		long residualAsLong = (long) Math.floor(residualError * PageRankBasic.precision);
		context.getCounter("page_rank", "residual_error").increment(residualAsLong);
